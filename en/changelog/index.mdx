...
<Update label="0.4.1" description="2026-09-14" rss={{ title: "Comet 0.4.1", description: "2026-09-14 release notes" }}>
...
- **Classic autonomous execution and recovery**: Opt into compact Agent-led implementation planning and execution while retaining five-phase validation, explicit user decisions, and independent review. Work-package checkpoints and delivery choices let interrupted workflows resume only unfinished authorized actions.
- **Capability evolution discovery**: Discover existing capabilities from Project Knowledge when creating Native or Classic changes. Associations remain revocable, and Native can merge stable requirement changes into canonical Specs.

### Changed

- **Workflow responsiveness**: In the measured Windows Runtime benchmark, median Classic latency falls by 70.6–76.9% for common `current` and `next` queries and by 19.3–23.3% for check execution, reuse, and invalidation. Native initial checks improve by 20.2%, and Shape-ready `next` improves by 26.0%. In same-task DeepSeek full-workflow evaluations, Native averaged 18.9% less time; the corrected-layout Classic rerun averaged 40.9% less time, an observed task-level difference rather than an isolated Runtime speedup.
- **Native verification and Specs**: Reuse checks only when their evidence still matches the current candidate and execution context, reduce unnecessary verification dispatches, and improve interrupted retries and complete independent verification after repairs. Delta and canonical Spec files no longer have arbitrary file-size, operation-count, or per-operation text limits; structural and integrity validation remains in place.
- **Installation and project updates**: Refreshing one project now updates the Comet npm package by default; use `--skip-self-update` to refresh assets only. Codex CodeGraph diagnostics now recognize project-scoped MCP configuration and effective overrides.

### Fixed

- **Dashboard status and interaction**: Project selection defaults to the launch project, and Classic and Native phases, waiting states, and verification results are shown more accurately. Background refresh no longer repeatedly shifts the page, and Native change totals use the same digit-scroll animation as Classic.
- **Personal Memory**: Learning remains traceable through review failures and recovery. CLI, Dashboard, and Remote Providers show skipped, deferred, candidate, promoted, deduplicated, and matching outcomes. Content containing ISO 8601 dates is no longer misclassified as phone numbers.
- **Platform and workflow compatibility**: dsh Hooks route write operations correctly instead of failing as an unsupported platform. Classic checks on Linux and macOS ignore build caches inside the configured process home. Initialization and updates create or refresh `CLAUDE.md` only for selected Claude Code targets.

</Update>

<Update label="0.4.0" description="2026-09-08" rss={{ title: "Comet 0.4.0", description: "2026-09-08 release notes" }}>
<Accordion title="0.4.0 release details" id="v0-4-0-details">
...
<Update label="0.4.0-rc.6" description="2026-09-07" rss={{ title: "Comet 0.4.0-rc.6", description: "2026-09-07 release notes" }}>
<Accordion title="0.4.0-rc.6 release details" id="v0-4-0-rc-6-details">
...
<Update label="0.4.0-rc.5" description="2026-09-05" rss={{ title: "Comet 0.4.0-rc.5", description: "2026-09-05 release notes" }}>
<Accordion title="0.4.0-rc.5 release details" id="v0-4-0-rc-5-details">
...
<Update label="0.4.0-rc.4" description="2026-09-04" rss={{ title: "Comet 0.4.0-rc.4", description: "2026-09-04 release notes" }}>
<Accordion title="0.4.0-rc.4 release details" id="v0-4-0-rc-4-details">
...
<Accordion title="0.4.0-rc.3 release details" id="v0-4-0-rc-3-details">
...
<Accordion title="0.4.0-rc.2 release details" id="v0-4-0-rc-2-details">
...
<Accordion title="0.4.0-rc.1 release details" id="v0-4-0-rc-1-details">
