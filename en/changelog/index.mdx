...
Beta 20 enables CodeGraph to facilitate quicker action in diagnosis and enhances Native's support for large-scale and constantly changing requirements.
...
- **Classic Skill Scheduling**: Removed the incorrect "disable-model-invocation" option from the classic skill.
