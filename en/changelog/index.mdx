...
Beta 18 expands Skill evaluation, Native orchestration for large requirements, and change visibility across worktrees.

### Added

- **Standalone Skill evaluation**: Run `comet eval ./my-skill` directly against a local Skill, with automatic or authored tasks, offline `--collect`, selectable evaluation Agents, independent Judge configuration, and the Langfuse suite.
