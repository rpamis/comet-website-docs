...
- **Legacy Native verification chain**: New changes no longer create the old project-scan, checkpoint, check, evidence, or receipt chain. Active legacy changes migrate conservatively when needed, and archived legacy changes remain read-only.
