...
Do not use hotfix for cross-module redesign, database schema changes, new capabilities, public API changes, or product design discussion. If you cannot classify the change, call `/comet` and describe its scope. When routing evidence is insufficient or conflicts with a risk signal, Comet asks for confirmation.
...
| Delta spec    | Exception only                     | Normal                                       | Formal artifact                    |
