...
In the normal flow, `branch_status` remains `pending`; do not write `handled` during re-verification. Archive records the confirmed delivery method.
...
## Scenario 4: upgrade hotfix or tweak to full
