...
description: "Integrate the existing code base into Comet Classic: how component detection, override, and skip are handled."
---
...
<Tip>
If you were previously using an old version of Superpowers (below 6.0.0), Superpowers' official data shows that 6.0.0+ is roughly twice as fast as the old version and uses about 50% fewer tokens. When upgrading, you can choose to overwrite the Superpowers component.
</Tip>
...
build or verify but without `.comet.yaml`, there is no reliable way to re-create Comet state afterward - you need to open a new change.
</Warning>
