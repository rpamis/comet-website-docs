...
|Signal|Meaning|
| --- | --- |
|Multiple capabilities that can be independently designed, built, verified and archived|These abilities are independent of each other and there is no need to bind them together|
