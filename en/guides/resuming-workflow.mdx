...
| -------------- | ----------------------------------------------------------------------------------- |
| `comet status` |When `/comet-classic` routes incorrectly or evidence does not match, and you need to check the current stage and whether declared artifacts still exist |
