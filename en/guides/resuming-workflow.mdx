...
|"Situation|"Behavior"|
| ------------------------------------------------------------------------ | ------------------------------------------------------------------- |
|`build_pause: plan-ready`, but `isolation`/`build_mode` have already been set|** Automatically clear ** the stale pause flag and continue execution (no action required)|
