...
<p align="center">
  <img src="/assets/cicd-integration-illustrations/01-ci-gate-json-checks.png" alt="Xiaoyu feeds status and doctor JSON tickets into a CI gate that passes or blocks a pull request" width="800" />
</p>
...
There are no active changes, or the change lacks `.comet.yaml` and was skipped. Use `/comet-classic` in an agent platform to bring it under Comet state.
</Accordion>
