...
During `comet init`, you select one or more platforms and Comet installs the skills to the appropriate directory for each. See the [Supported Platforms](/en/platforms) page for the full list of 28 platforms and their directory mappings.
...
See the [State Management](/en/concepts/state-management) concept page for full field-by-field documentation of both files.
