...
| --- | --- | --- |
| `openspec/changes/<name>/.comet.yaml` | User-readable workflow projection: phase, workflow, build decisions, verification result, run id | Agent and Comet scripts |
...
| `.comet/config.yaml` | Project-level Comet settings | User |
