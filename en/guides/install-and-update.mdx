...
Installing only Native always uses Copy. For the detailed differences between the two modes, see [Supported platforms · Installation mode](/en/platforms#installation-mode-copy-vs-symbolic-link).
