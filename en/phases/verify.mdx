...
Run `/comet-verify` directly, or let `/comet-classic` auto-dispatch when all tasks in `tasks.md` are checked. Both OpenSpec and Superpowers contribute to this phase.
