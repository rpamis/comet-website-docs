---
title: "build Phase"
description: "During the build phase, write the implementation plan, allowing you to choose the execution, TDD, and review methods, and then turn the design into code - execute, review, and submit tasks one by one."
---

The build stage turns the design into code. Classic will prepare and bind the workspace in the Open phase first. After entering build, it first writes the implementation plan, then allows you to choose the execution, TDD, and review methods at the pause points, and then executes, reviews, and submits tasks one by one. From your perspective, this is the "hands-on implementation" stage - but Comet will give you the choice of the execution method and handle spec incremental updates and exception debugging during the process.
