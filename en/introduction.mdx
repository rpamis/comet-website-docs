...
| Parallel work | Developers split tasks, work out dependencies, assign working directories, track completion, and merge results themselves | Supervisor Change **automates the DAG, analyzes child dependencies, and supports multi-session and Agent Teams parallelism**, prepares a **dedicated worktree** for each child task, and validates the integrated result |
