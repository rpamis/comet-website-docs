...
<Info title="Comet and industry practice" icon="scale-balanced">
  Read the [comparison article](/en/tech-blog/comet-vs-industry) for references and boundaries covering evaluation, runtime, workflow, and Skill distribution.
</Info>
...
The Comet runtime depends on Node.js. State, guards, handoffs, and archiving run through the Node entry point; Bash, Git Bash, and WSL are not workflow prerequisites.
