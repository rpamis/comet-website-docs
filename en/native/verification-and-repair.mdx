...
<p align="center">
  <img src="/assets/native-illustrations/07-verification-evidence.png" alt="Xiaoyu removes a faded verification receipt from a photo board and prepares a fresh check at the workbench, showing that changed inputs stale old evidence" />
</p>
...
Continue with [Native workflow](/en/concepts/native-workflow#four-phase-workflow), [Safety and recovery](/en/native/safety-and-recovery), and [Multiple changes and specification conflicts](/en/native/multi-change-and-conflicts).
