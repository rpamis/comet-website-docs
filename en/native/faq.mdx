...
Continue with [Native configuration](/en/native/configuration), [Artifacts and state](/en/native/artifacts-and-state), and [Verification evidence and autonomous repair](/en/native/verification-and-repair).
