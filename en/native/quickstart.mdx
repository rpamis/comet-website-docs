...
description: 'Initialize Native for a strong model and complete a recoverable change.'
---

Native leaves planning and implementation methods to the model, but the Runtime owns the completion verdict. A Builder cannot finish a change by saying “done”: Runtime runs necessary checks and dispatches a fresh read-only Verifier to cover every acceptance item.
