...
- the second recurrence of the same gap warns, and the third recurrence without progress becomes a manual stop;
...
Repeated-gap stopping and the total failure budget apply independently. Only a user-confirmed contract change starts a new goal cycle; stop conditions do not mechanically count phase transitions.
