...
Continue reading: [Which decisions need your confirmation](/en/native/decision-ownership), [Sequential and Batch clarification](/en/native/clarification-modes), [Native Loop](/en/native/native-loop), and [Continuous progression and stable recovery points](/en/native/continuation-and-checkpoints).
