...
This page is the authoritative description of the Skill publishing state machine, readiness, and blocker codes; for the command-level reference, see [comet publish](/en/cli/publish).
