...
`.comet/skill-preferences.yaml` is a project-level preference file. It tells `/comet-any` which Skills the project prefers to reuse, and how to handle missing, ambiguous, drifted, script, and hook cases.

This file records composition preferences. It is not a strict allowlist or internal runtime state. You can write and commit it in the project, or let `/comet-any` create it after the first scan.
