...
<Note>
  ...
  - **An AI coding tool** — Claude Code, Cursor, Windsurf, GitHub Copilot, Gemini CLI, or any of the [31 supported platforms](/en/platforms)
</Note>
...
If any check shows `✗`, the output includes a suggested fix. Re-run `comet init` or consult the [CLI Reference](/en/cli/init) for remediation options.
...
<CardGroup cols={2}>
  <Card title="Workflow Deep Dive" icon="arrows-rotate" href="/en/concepts/workflow">
  ...
  <Card title="Scripts Overview" icon="scroll" href="/en/scripts/overview">
