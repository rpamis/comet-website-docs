...
Only Classic initialization installs or configures OpenSpec, Superpowers, CodeGraph, phase rules, and hooks.

<Info>
  A project-scope installation records the project's default workflow, making it suitable for teams.
  A global installation provides global capabilities only; it does not choose Native or Classic for
  any project.
</Info>
...
- For Native commands, see [Native CLI](/en/cli/native).
