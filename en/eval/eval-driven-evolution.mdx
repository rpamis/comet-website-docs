...
<Warning>
  This is advanced Eval content for teams and source maintainers. Reproducing the harness, tracing,
  and experiment workflows requires a Comet source checkout; ordinary users can skip these internals
  and use [Quickstart](/en/eval/quickstart).
</Warning>
