...
This page summarizes a real Comet workflow baseline evaluation. It shows how to read a comparison report: confirm the data scope first, then inspect task outcomes, reliability metrics, rubric dimensions, cost, and failure attribution.
...
The report verdict says `COMET_FULL_040_BETA` has an overall workflow score of `0.89`, above `COMET_FULL_039` at `0.82`, with no dimension regressing beyond the `0.05` tolerance.
...
![Manage Skill baselines in LangSmith and review evaluation metrics, latency, and token consumption](/img/langsmith-dataset-v2.png)

*Manage your Skill baseline in LangSmith and view detailed performance metrics, latency, and token consumption*

![Trace the full Claude Code run in LangSmith](/img/langsmith-trace-v2.png)

*Trace your Claude Code in LangSmith*

![Track custom Rubric metrics with Pytest in LangSmith](/img/langsmith-baseline-detail-v2.png)
