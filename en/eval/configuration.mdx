...
<Info>
  This article is advanced customization. If you just want to evaluate an existing Skill, you don't need to read it — just use <code>comet eval ./your-skill --html</code>. This article assumes you can already run <code>comet eval ./your-skill --collect</code> successfully.
</Info>
