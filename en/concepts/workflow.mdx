...
Comet turns a coding request into a recoverable workflow. OpenSpec records the product change and authoritative spec. Superpowers drives deeper design, planning, implementation, and verification. Comet links them with phase state, handoff hashes, and guard checks. Combining OpenSpec and Superpowers is not Comet's end goal; we want to keep tracking long-running task Skills like this and identify the Harness capabilities that make long-chain Skill execution stable. If this direction interests you, you are welcome to contribute to the project or learn from the source code.
