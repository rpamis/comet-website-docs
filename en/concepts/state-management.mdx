...
| `branch_status` | `pending` \| `handled` | Stays `pending` through verify and archive; written `handled` only after the archive commit and branch handling complete |
