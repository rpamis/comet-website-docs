...
`comet archive` is the stable entry point for the archive phase. A mutating archive requires a verified change and recorded final confirmation; `--dry-run` can preview the operation before confirmation.
