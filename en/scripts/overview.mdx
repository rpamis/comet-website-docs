...
<CardGroup cols={2}>
  <Card title="comet-guard.sh" icon="shield-check" href="/en/scripts/comet-guard">
    Phase transition guard — validates exit conditions before advancing the workflow
  </Card>
  <Card title="comet-state.sh" icon="database" href="/en/scripts/comet-state">
    Unified state management — the exclusive interface for reading and writing `.comet.yaml`
  </Card>
  <Card title="comet-handoff.sh" icon="arrow-right-arrow-left" href="/en/scripts/comet-handoff">
    Design context handoff — generates SHA256-traced context packages from OpenSpec artifacts
  </Card>
  <Card title="comet-archive.sh" icon="box-archive" href="/en/scripts/comet-archive">
