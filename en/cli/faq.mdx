...
<AccordionGroup>
  ...
  <Accordion title="How do I choose between project-level and global installation?">
    Project scope is suited for team projects (config is written to the repository for easy collaboration), while global scope is suited for personal default environments (written to the user directory, shared across projects). When unsure, start with project scope. See [comet init](/en/cli/init).
  </Accordion>
