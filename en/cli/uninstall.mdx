...
<Warning>
  Uninstall removes only Comet-owned Skills, rules, hooks, and config fragments. It preserves project code, OpenSpec changes, Design Docs, Plans, verification reports, and unrelated third-party Skills.
</Warning>
