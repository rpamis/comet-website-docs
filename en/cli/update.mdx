...
description: "comet update upgrades the npm package and refreshes Comet skill files across all detected targets. Flags: --json, --language (en|zh), --scope (global|project)."
---
