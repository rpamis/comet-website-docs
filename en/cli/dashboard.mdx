...
In the Native workspace, independent changes appear as root entries. A parent change can be expanded to show child status, branches, and progress. Selecting either the parent or a child opens its corresponding detail while Dashboard remains read-only.
