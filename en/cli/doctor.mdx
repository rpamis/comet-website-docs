---
title: "comet doctor — Check installation and project health"
...
Comet Doctor (scope: project)
  ...
  ✓ Comet CLI: installed (0.4.0-beta.18)
...
| `CodeGraph`                                         | Whether CodeGraph is uninitialized, incomplete, or waiting for index synchronization. |
  ...
  "results": [
    {
      "check": "Comet CLI",
      "status": "pass",
      "message": "installed (0.4.0-beta.18)"
    },
    {
