...
description: "Learn how Comet turns user feedback, task results, and project evidence into traceable Personal Memory and Project Knowledge."
---

Agent Learning Loop records, filters, and applies Personal Memory and Project Knowledge. It provides relevant records for the current task and tracks their lifecycle.
...
- **Project Knowledge** retains project structure, design rationale, change relationships, and verified engineering experience.

Agent Learning Loop does not require a third plugin.

![Personal Memory stores user preferences and experiences. Project Knowledge stores project structure, facts, dependencies, and evidence. Together they form task context that Agent Learning Loop updates.](/img/rc1-highlights-v2/04-memory-and-knowledge-landscape-en.png)
...
## Industry practice and Comet's boundary
...
Comet records the owner, source, scope, source status, and application result for each long-term record. You can inspect, correct, and trace why a record entered a task.
...
|Hook/Check|Observe, block or verify engineering constraints| Hook、linter、test、build、CI          |Execution environment|

> Project Knowledge helps agents understand the project, rules provide team instructions, hooks and engineering checks enforce constraints deterministically.
...
Clear long-term requirements take effect directly through fixed rules. For instance, if you propose "I will answer in Chinese by default from now on", your Personal Memory can take effect immediately.
...
Automatically generated content needs to be verified and reused to gain higher priority. Comet retains the following states for records:

|"Status"|Product meaning|
| ------------ | ---------------------------------------------------- |
| `trial`      |Have a preliminary basis and participate in relevant tasks with a lower priority|
| `proven`     |Stable content from clear requirements, directly verifiable facts or successful reuse|
...
- [Project Knowledge: Accumulate reusable project understanding](/en/plugins/project-rules)
