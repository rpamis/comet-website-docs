...
| Rule / Agent instructions | Prescribe how the Agent behaves in scope | Rule files or rule directories supported by the target platform | The repository or host |
