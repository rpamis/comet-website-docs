...
The Dashboard's **Personal Memory** page shows each record's type, scope, source summary, state, application reason, and recent results. You can add, correct, forget, roll back, or expand the full information.
