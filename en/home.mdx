...
<div className="comet-home">
  ...
  <section className="comet-home__platforms" data-reveal="true" data-reveal-threshold="0.1" data-reveal-distance="38" aria-labelledby="comet-platforms-title">
    ...
    <p className="comet-home__platforms-sub">
      Comet supports 34 AI coding platforms. The initialization wizard installs and configures Comet for each detected platform.
    </p>
    <div className="comet-home__platforms-marquee" aria-label="34 AI coding platforms supported by Comet" translate="no">
