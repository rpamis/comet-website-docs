...
<div className="comet-home">
  ...
  <section className="comet-home__supervisor" aria-labelledby="comet-supervisor-title">
    <div className="comet-home__supervisor-head" data-reveal="true" data-reveal-distance="36">
      <div>
        ...
        <h2 id="comet-supervisor-title">Break down complex requirements,<br />then run multiple agents in parallel</h2>
      </div>
      <p className="comet-home__supervisor-lede">
        Comet Supervisor Change coordinates a complex objective and divides it along real delivery boundaries into child Changes that can be implemented and verified independently.
        A DAG then manages dependencies, isolated worktrees, integration, and final acceptance. Choose Codex multi-session execution or Claude Code Agent Teams to run them in parallel.
      </p>
    </div>
    ...
    <div className="comet-home__supervisor-grid">
      <div className="comet-home__supervisor-column" data-reveal="true" data-reveal-distance="32" role="group" aria-labelledby="supervisor-codex-title">
        <div className="comet-home__supervisor-copy">
          ...
          <p>The Supervisor coordinates independent sessions that implement, verify, and report back from their own worktrees.</p>
        </div>
        <SupervisorVideo
          src="/vedio/codex.mp4"
          width={1230}
          height={858}
          label="Comet Supervisor coordinating multiple independent sessions in Codex"
      ...
      <div className="comet-home__supervisor-column" data-reveal="true" data-reveal-delay="110" data-reveal-distance="32" role="group" aria-labelledby="supervisor-claude-title">
        <div className="comet-home__supervisor-copy">
          ...
          <p>The Supervisor dispatches an Agent Team to run tasks in dependency order, then the Runtime consolidates status and integration.</p>
        </div>
        <SupervisorVideo
          src="/vedio/claude%20code.mp4"
          width={1548}
          height={1080}
          label="Comet Supervisor running tasks in parallel with Agent Teams in Claude Code"
          fallback="Your browser does not support HTML5 video."
        />
      </div>
    </div>
  ...
  <section className="comet-home__platforms" data-reveal="true" data-reveal-threshold="0.1" data-reveal-distance="38" aria-labelledby="comet-platforms-title">
    ...
    <p className="comet-home__platforms-sub">
      Comet supports 35 AI coding platforms. The initialization wizard installs and configures Comet for each detected platform.
    </p>
    <div className="comet-home__platforms-marquee" aria-label="35 AI coding platforms supported by Comet" translate="no">
  ...
  >
    ...
    <p className="comet-home__handoff-copy">
      Comet controls each phase, maintains state, and evaluates results.<br />
  ...
  >
    <div className="comet-home__capability-grid">
      <div className="comet-home__capability-card" role="group" aria-labelledby="comet-capability-skill">
        ...
        <p>Run agents in stages throughout long-running work, persist state, and resume after interruptions.</p>
      </div>
