...
<div className="comet-home">
  ...
  <section className="comet-home__hero" aria-labelledby="comet-home-title">
    ...
    <div className="comet-home__actions" aria-label="Start using Comet">
      <a className="comet-home__btn comet-home__btn--primary" href="/en/overview">
        Get started
        <span aria-hidden="true">→</span>
      </a>
      <a className="comet-home__btn comet-home__btn--ghost" href="/en/quickstart">Read the docs</a>
    </div>
  </section>
