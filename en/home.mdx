...
<div className="comet-home">
  ...
  <section className="comet-home__feature comet-home__feature--reverse" aria-labelledby="comet-eval-title">
    <div className="comet-home__copy" data-reveal="true" data-reveal-delay="110" data-reveal-distance="38">
      ...
      <p className="comet-home__copy-lede">
        Comet Eval uses a dual-Agent automated evaluation architecture: the Agent under test runs the Skill, a user-simulation Agent replies automatically at decision points, and <code translate="no">--resume</code> resume the same session so the whole multi-phase workflow runs end to end on its own.
