  ...
  <section className="comet-home__supervisor" aria-labelledby="comet-supervisor-title">
    <div className="comet-home__supervisor-head" data-reveal="true" data-reveal-distance="36">
      <div>
        ...
        <h2 id="comet-supervisor-title">Split complex changes<br />across agents in parallel</h2>
      </div>
      <p className="comet-home__supervisor-lede">
        A Supervisor Change divides a complex goal into independently verifiable tasks. Comet manages dependencies, isolated worktrees, acceptance, and integration,
        while you choose between Codex multi-session execution and Claude Code Agent Teams.
      </p>
    </div>
