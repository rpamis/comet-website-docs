...
import { DecryptedTextController } from "/snippets/decrypted-text.jsx";
...
<div className="comet-home">
  ...
  <section className="comet-home__hero" aria-labelledby="comet-home-title">
    ...
    <h1 id="comet-home-title">
      ...
      <span className="comet-home__title-accent">
        只需要{" "}
        <span className="comet-home__title-command" data-decrypt-text="/comet" data-decrypt-state="idle" aria-label="/comet">
          <span className="comet-home__title-command-output" aria-hidden="true">
            <span data-decrypt-resolved>/comet</span>
            <span className="comet-home__title-command-encrypted" data-decrypt-encrypted></span>
          </span>
        </span>{" "}
        一个命令
      </span>
    ...
    <div className="comet-home__install-chip" translate="no">
      ...
      <button
        ...
        title="复制安装命令"
      >
        <svg className="comet-home__copy-icon" viewBox="0 0 20 20" aria-hidden="true">
          <rect x="6.5" y="6.5" width="9" height="9" rx="1.5" />
          <path d="M13.5 6.5V5A1.5 1.5 0 0 0 12 3.5H5A1.5 1.5 0 0 0 3.5 5v7A1.5 1.5 0 0 0 5 13.5h1.5" />
        </svg>
        <svg className="comet-home__copy-icon comet-home__copy-icon--success" viewBox="0 0 20 20" aria-hidden="true">
      ...
      <div className="comet-home__window comet-home__window--terminal comet-home__setup-terminal" aria-label="Comet 安装与初始化执行轨迹">
        ...
        <div className="comet-home__setup-viewport" data-setup-viewport translate="no">
          ...
          <div className="comet-home__setup-line" data-setup-line data-setup-stage="init" data-setup-pause="560">
            ...
            <span>v0.4.0-beta.9 · You are on the latest version.</span>
          </div>
  ...
  {/* ====================== INSTALL ====================== */}
  <section className="comet-home__install" data-reveal="true" data-reveal-threshold="0.12" data-reveal-distance="38" aria-labelledby="comet-install-title">
