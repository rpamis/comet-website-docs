...
<div className="comet-home">
  ...
  <section className="comet-home__hero" aria-labelledby="comet-home-title">
    ...
    <div className="comet-home__actions" aria-label="开始使用 Comet">
      <a className="comet-home__btn comet-home__btn--primary" href="/zh/overview">
        立即开始
        <span aria-hidden="true">→</span>
      </a>
      <a className="comet-home__btn comet-home__btn--ghost" href="/zh/quickstart">阅读文档</a>
    </div>
  </section>
  ...
  <section className="comet-home__feature" aria-labelledby="comet-skill-title">
    <div className="comet-home__copy" data-reveal="true" data-reveal-distance="38">
      ...
      <p className="comet-home__copy-lede">
        在 AI 编码工具里调用 <code translate="no">/comet</code>。Comet 按项目配置进入 Native 或 Classic，让一次变更从想法稳定走到归档——即使跨设备、零上下文，依然能够在中断之后从原处继续
      </p>
      <div className="comet-home__modes">
        <div className="comet-home__mode">
          <div className="comet-home__mode-head">
            ...
            <h3>面向强模型 · 全自动 Coding</h3>
          </div>
          <p>Loop Engineering 驱动，为 Fable 5、GPT 5.6 这类能自主完成复杂代码推理的强模型设计。模型用结构化问题高强度澄清需求、起草目标 Spec，由你确认；实现交给模型自动循环推进，Comet 在澄清、目标 Spec 与结果验证上把关</p>
        </div>
        <div className="comet-home__mode">
          <div className="comet-home__mode-head">
            <span className="comet-home__mode-tag" translate="no">Classic</span>
            <h3>经典 Spec 驱动 · 更多 HITL</h3>
          </div>
          <p>Open → Design → Build → Verify → Archive 五阶段工作流，连接 OpenSpec 与 Superpowers；用 Design Doc 与显式确认点约束每一步，适合需要严密流程的较大变更，以及非 Fable 级模型</p>
        </div>
      </div>
    ...
    <div className="comet-home__supervisor-grid">
      <div className="comet-home__supervisor-column" data-reveal="true" data-reveal-distance="32" role="group" aria-labelledby="supervisor-codex-title">
        <div className="comet-home__supervisor-copy">
          ...
          <p>Supervisor 负责协调，多个独立会话在各自 worktree 中执行、验证并回传结果</p>
        </div>
        <SupervisorVideo
          src="/vedio/codex.mp4"
          width={1230}
      ...
      <div className="comet-home__supervisor-column" data-reveal="true" data-reveal-delay="110" data-reveal-distance="32" role="group" aria-labelledby="supervisor-claude-title">
        <div className="comet-home__supervisor-copy">
          ...
          <p>Supervisor 调度 Agent Team，按依赖并行推进子任务，再由 Comet 运行时汇总状态并完成集成</p>
        </div>
        <SupervisorVideo
  ...
  <section className="comet-home__evolving" aria-labelledby="comet-evolving-title">
    <div className="comet-home__evolving-copy" data-reveal="true" data-reveal-distance="38">
      ...
      <h2 id="comet-evolving-title">每一次任务，<br />都让 Agent 更懂你与项目</h2>
      <p className="comet-home__evolving-lede">
        Comet 把用户反馈、任务结果、Review、验证和归档中的可复用经验沉淀为后续任务上下文，
        只提供当前场景需要的部分，并根据实际应用结果继续校准
      </p>
      ...
      <div className="comet-home__evolving-domains">
        <div className="comet-home__evolving-domain">
          ...
          <div>
            <h3>个人记忆</h3>
            <p>沉淀你的偏好、协作方式和经过验证的个人经验，让跨会话协作保持一致</p>
          </div>
        </div>
        <div className="comet-home__evolving-domain">
          ...
          <div>
            <h3>项目知识</h3>
            <p>从代码、配置、Review 和验证中建立项目模型与项目规范；来源变化后自动停用过时内容</p>
          </div>
        </div>
      </div>

      <a className="comet-home__text-link" href="/zh/plugins/agent-learning-loop">
        了解自进化机制
        <span aria-hidden="true">→</span>
      </a>
    </div>
  ...
  <section className="comet-home__blocks" aria-labelledby="comet-blocks-title">
    ...
    <ul className="comet-home__blocks-grid" data-reveal="true" data-reveal-distance="30">
      ...
      <li className="comet-home__block">
        ...
        <h3>评估驱动</h3>
        <p>用真实任务评分和失败归因，让 Skill 的演进有据可依</p>
      </li>
      <li className="comet-home__block">
  ...
  <section className="comet-home__platforms" data-reveal="true" data-reveal-threshold="0.1" data-reveal-distance="38" aria-labelledby="comet-platforms-title">
    ...
    <p className="comet-home__platforms-sub">
      Comet 支持 37 个 AI 编码平台，初始化向导按平台完成安装与配置
    </p>
    <div className="comet-home__platforms-marquee" aria-label="Comet 支持的 37 个 AI 编码平台" translate="no">
      ...
      <div className="comet-home__footer-socials" aria-label="Comet 社交媒体与联系方式">
        ...
        <button type="button" className="comet-home__footer-social comet-home__footer-social--qr" aria-label="显示微信群二维码">
          ...
          <span className="comet-home__footer-qr" role="tooltip">
            <img src="/img/community-wechat.png" loading="lazy" decoding="async" alt="Comet 微信群二维码" width="132" height="132" />
            <span>微信群</span>
          </span>
        </button>
        <button type="button" className="comet-home__footer-social comet-home__footer-social--qr" aria-label="显示抖音群二维码">
          ...
          <span className="comet-home__footer-qr" role="tooltip">
            <img src="/img/community-douyin.png" loading="lazy" decoding="async" alt="Comet 抖音群二维码" width="132" height="132" />
            <span>抖音群</span>
          </span>
        </button>
        <button type="button" className="comet-home__footer-social comet-home__footer-social--qr" aria-label="显示QQ群二维码">
          ...
          <span className="comet-home__footer-qr" role="tooltip">
            <img src="/img/community-qq.jpg" loading="lazy" decoding="async" alt="Comet QQ群二维码" width="132" height="132" />
            <span>QQ群</span>
          </span>
        </button>
        <button type="button" className="comet-home__footer-social comet-home__footer-social--qr" aria-label="显示 Sponsor 赞助码">
          ...
          <span className="comet-home__footer-qr comet-home__footer-qr--sponsor" role="tooltip">
            <img src="/img/sponsor.jpeg" loading="lazy" decoding="async" alt="Comet Sponsor 微信赞助码" width="140" height="198" />
            <span>Sponsor</span>
          </span>
        </button>
      </div>
