...
<div className="comet-home">
  ...
  <section className="comet-home__platforms" data-reveal="true" data-reveal-threshold="0.1" data-reveal-distance="38" aria-labelledby="comet-platforms-title">
    <p className="comet-home__label" translate="no">34 platforms</p>
    <h2 id="comet-platforms-title">在你已经在用的工具里运行</h2>
    <p className="comet-home__platforms-sub">
      Comet 支持 34 个 AI 编码平台，初始化向导按平台完成安装与配置
    </p>
    <div className="comet-home__platforms-marquee" aria-label="Comet 支持的 34 个 AI 编码平台" translate="no">
