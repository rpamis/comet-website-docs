...
sidebarTitle: "Hotfix"
description: "hotfix 预设会跳过 brainstorming 和 deep design，直接从 open 进入 build、verify 和 archive，适合小型且已充分理解的 bug fixes。"
---

hotfix 预设面向小型、聚焦且解决方案已经清晰的 bug fixes。它会跳过 brainstorming phase 以更快推进，提供一条从问题描述到 archived fix 的精简路径，避免 full workflow design 的开销。
