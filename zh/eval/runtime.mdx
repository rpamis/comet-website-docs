...
<p align="center">
  <img src="/assets/eval-runtime-illustrations/01-comet-eval-skill-eval-boundary.png" alt="小鱼把 comet eval 的发布证据和 comet skill eval 的 Run 完成度检查分到两张工作台" width="800" />
</p>

<p align="center">comet eval 产出发布证据；comet skill eval 只检查某次 Run 是否完整</p>
