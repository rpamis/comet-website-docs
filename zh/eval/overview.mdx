...
<p align="center">
  <img src="/assets/eval-overview-illustrations/01-two-eval-systems.png" alt="小鱼把 comet eval 的发布证据和 comet skill check 的运行检查分到两个文件盒" width="800" />
</p>

<p align="center">`comet eval` 是发布前证据，`comet skill check` 是运行期检查，两者不要混用</p>
