...
design 阶段的核心是一段**基于真实上下文的 brainstorming**。brainstorming 直接使用脚本从 open 阶段 artifacts 生成的**交接包**，设计依据因此来自真实需求和项目文件。
...
<p align="center">
  <img
    ...
    alt="小鱼用脚本夹板把真实 OpenSpec artifacts 压成带 sha256 标记的 handoff 交接包"
    width="800"
  />
</p>

<p align="center">handoff 交接包由脚本直接读取真实 artifacts 生成</p>
