...
<p align="center">
  <img src="/assets/skill-creator-publishing-illustrations/01-evidence-to-distribute-preview-new.png" alt="小鱼检查 eval evidence v2 的 draftHash 和 evalManifestHash，再通过 creator status/next、review、approve 和 publish preview 推进发布" width="800" />
</p>
