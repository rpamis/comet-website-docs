...
`comet publish` 是普通用户发布 `/comet-any` 产物的入口。它负责 eval 证据就绪后的 review、approval、publish 和 distribute。创建、恢复和"下一步该做什么"由 [comet creator](/zh/cli/creator) 负责。
...
- [comet creator](/zh/cli/creator) — 创建状态、恢复和唯一的下一步
