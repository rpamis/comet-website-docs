...
- **应该提交**：Classic 产物根（新项目为 `docs/openspec/`，保留旧布局的项目为 `openspec/`）、`docs/superpowers/`、`.comet/config.yaml`、`.comet/skill-preferences.yaml`。这些是事实来源，提交后才能跨设备恢复。Native 产物的提交建议见[产物与状态](/zh/native/artifacts-and-state)。
