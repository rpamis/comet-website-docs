...
| 配置项                        | 允许值                            | 默认值                                                     | 含义                                                                                         |
| ----------------------------- | --------------------------------- | ---------------------------------------------------------- | -------------------------------------------------------------------------------------------- |
| `classic.artifact_layout`     | `legacy` \| `docs`                | 新项目为 `docs`；已有项目未配置时为 `legacy`               | 选择 OpenSpec 根目录：`openspec/` 或 `docs/openspec/`                                        |
...
<Warning>
  ...
  <code>comet classic root move docs --dry-run</code> 生成计划，再用{' '}
  <code>--apply --plan &lt;plan-id&gt;</code> 执行迁移。
</Warning>
...
<Info>
  ...
  <code>comet update</code> 会把旧值迁入新块。
</Info>
